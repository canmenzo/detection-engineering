...
15 rules, 122 labelled events. Generated by `detkit eval`; CI fails if this table drifts from the corpus.

| rule | level | precision | recall | FP rate | bar it must clear |
|---|---|---:|---:|---:|---|
| `proc_creation_win_encoded_powershell` | high | 1.00 | 0.80 | 0.00 | p≥0.90, r≥0.80, fp≤0.10 |
